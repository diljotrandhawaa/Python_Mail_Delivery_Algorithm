...
class Package:
    def __init__(self, p_id, address, city, state, zip, delivery_deadline, weight, status, delivery_time, truck_id):
        self.p_id = p_id
    ...
    def __str__(self):
        return "%s, %s, %s, %s, %s, %s, %s, %s, %s" % (self.p_id, self.address, self.city, self.state, self.zip,
